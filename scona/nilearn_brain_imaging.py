...
def plot_connectome_with_nilearn(
    ...
    """
    adjacency_matrix, node_coords, colour_list, size_list = \
            graph_to_nilearn_array(G, node_colour_att=node_colour_att, node_size_att=node_size_att, edge_attribute=edge_attribute)
...
def view_connectome_with_nilearn(
    ...
    adjacency_matrix, node_coords, colour_list, z = graph_to_nilearn_array(
        ...
        node_colour_att=node_colour_att)
